...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y):
    ...
    if button_clicked and not stats.game_active:
        ...
        sb.prep_level()
        sb.prep_ships()
        #Очистка списков прицельцев и пуль.
        aliens.empty()
        bullets.empty()
        #Создание нового флота и размещение корабля в центре.
        create_fleet(ai_settings, screen, ship, aliens)
...
def update_screen(ai_settings, screen, stats, sb, ship, alien, bullets, play_button):
    ...
    #Отображение последнего прописованного экрана.
    pygame.display.flip()
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Обработка коллизий пуль с прицельцами"""
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hip(ai_settings, stats, screen, sb, ship, aliens, bullets)

    #Проверка пришельцев, добравшихся до нижнего края экрана.
    check_aliens_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets)

def ship_hip(ai_settings, stats, screen, sb, ship, aliens, bullets):
